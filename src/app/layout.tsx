...
const structuredData = {
  ...
  name: "Left or Right?",
  description:
    "Test your surgical skills in this addictive 'Left or Right?' game. Play as a robot doctor performing appendectomies - choose the correct side and see if you can save the day!",
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Left or Right? - Robot Doctor Surgery Game",
    description:
      "Test your surgical skills in this addictive 'Left or Right?' game. Play as a robot doctor performing appendectomies!",
    images: ["/normal.webp"],
  ...
  other: {
    ...
    "DC.description":
      "Test your surgical skills in this addictive 'Left or Right?' game",
  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-7Y52PFH4XL"
